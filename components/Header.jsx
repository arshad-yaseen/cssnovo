...
function Header(props) {
  ...
  return (
    <header className={`w-full h-24 z-50  flex items-center sticky top-0  ${props.nobgcolor != true ? "bg-[#F0F1EE]" : ''}  ` }>
      <Link href="/" className="w-[33.333%] hover:opacity-80 transition-opacity flex items-center h-full cursor-pointer pl-10">
        <Image
          ...
          className="mt-1.5"
        />
        <h3 className="font-medium text-2xl text-[#161616] ml-3">{props.dashboard ? "cssnovo tools" : "cssnovo"}</h3>
      </Link>
      ...
      <div className="w-[33.333%] h-full flex justify-end items-center">
        {
          ...
          <Image src={whiteLogo} alt="profile" height={40} className="rounded-full mr-14 cursor-pointer hover:opacity-80 transition-opacity " />
          ...
          <DropdownMenu.Portal>
            ...
            >
              ...
              <DropdownMenu.Item disabled className="group font-regular cursor-pointer text-[14px] leading-none text-[#4352FF]/80 rounded-[3px] flex items-center h-[25px] px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-mauve8 data-[disabled]:pointer-events-none hover:bg-[#4352FF]/80 data-[highlighted]:text-violet1">
                Basic plan
              </DropdownMenu.Item>
