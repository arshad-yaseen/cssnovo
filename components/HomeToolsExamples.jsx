...
function HomeToolsExamples() {
  return (
      <div className="flex justify-center">
        ...
        <div className="w-fit mx-4 my-4 cursor-pointer hover:opacity-70 transition-opacity h-[60px] bg-white px-6 rounded-xl border-black border-2 flex  items-center ">
