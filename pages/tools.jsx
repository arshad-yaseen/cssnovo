  ...
  let tools = [
    {
      ...
      icon: <SiCodereview className="text-4xl opacity-50 absolute right-6 top-8" />,
    },
    {
      name: "Debugging Code",
      description: "Get to the root of the problem with Debugging Code, your go-to debugging tool.",
      icon: <VscDebugAltSmall className="text-4xl opacity-50 absolute right-6 top-8" />,
    },
    {
      name: "Optimize and Improve Performance of Code",
      description: "Make your code faster, better, and more efficient.",
      icon: <SiSpeedtest className="text-4xl opacity-50 absolute right-6 top-8" />,
    },
    {
      name: "Framework Converter",
      description: "Convert your code to your preferred framework with ease",
      icon: <SiConvertio className="text-4xl opacity-50 absolute right-6 top-8" />,
    },
    {
    ...
    },
    {
      ...
      description: "Convert your CSS to responsive code effortlessly and create a seamless mobile experience for your users.",
      icon: <SiConvertio className="text-4xl opacity-50 absolute right-6 top-8" />,
    },
    {
    ...
    },
    {
      ...
      description: "Generate CSS styles from HTML code effortlessly with our Auto CSS Code Generator.",
      icon: <IoIosCreate className="text-4xl opacity-50 absolute right-6 top-8" />,
    }
  ]
        ...
        <div className="w-[800px]  h-[60vh] mt-5 flex flex-col overflow-scroll  items-center pr-5">

          {
            tools.map((tool,index) => {
              return (
                <Link href="/tools/review-code" key={index} className={`w-full ${index !== 0 ? "opacity-50  pointer-events-none" : "hover:shadow-lg"} min-h-[100px] mt-5 relative bg-[#E4E2DE]  cursor-pointer transition-shadow flex flex-col rounded-xl justify-center pl-8`}>
                  <h1 className="font-medium text-2xl ">{tool.name}</h1>
                  <p className="text-sm font-regular text-[#494849] mt-2">{tool.description}</p>
                  <div className="flex">
                    {tool.icon}
                  </div>
                </Link>
